...
public class CommandMutelist extends CoreCommand {

    public CommandMutelist() {
        super(true, PermissionType.STAFF, "mutelist", "mutes");
    }
    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        for (Map.Entry<String, PunishData> mute : DataUtils.getMutes().entrySet()) {
            MessageBuilder builder = new MessageBuilder();
            String uuid = mute.getKey();
            String name = NameUtils.getUsername(UUID.fromString(uuid));

            PunishData data = mute.getValue();
