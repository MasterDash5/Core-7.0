...
public class CommandIpbanlist extends CoreCommand {

    public CommandIpbanlist() {
        super(true, PermissionType.ADMIN, "ipbanlist", "baniplist", "ipbans", "banips");
    }
    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        for (Map.Entry<String, PunishData> ban : DataUtils.getIpbans().entrySet()) {
            MessageBuilder builder = new MessageBuilder();
            String address = ban.getKey();
            ...
            builder.append("&7 - &6" + address + " &7for &6" + reason)
