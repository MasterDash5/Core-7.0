...
public class CommandKick extends CoreCommand {
    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        if (length <= 0) {
            MessageUtils.message(sender, ColorUtils.translate("&6&l» &7/kick <player> <reason>"));
            return;
        }
        ...
        if (sender instanceof ProxiedPlayer) {
            ...
            if (!user.isAbove(User.getUser(target))) {
                MessageUtils.message(sender, ColorUtils.translate("&6&l» &7You don't have permission to kick that player."));
                return;
            }
        }
