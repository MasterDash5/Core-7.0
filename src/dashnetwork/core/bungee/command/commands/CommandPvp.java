    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        for (ProxiedPlayer target : targets) {
            if (target.equals(sender))
                MessageUtils.message(target, "&6&l» &7Sending you to &6PvP");
            else {
                ...
                message.append("&7 sent you to &6PvP");
            ...
            target.connect(bungee.getServerInfo("pvp"));
        }
        ...
        if (!moved.isEmpty()) {
            ...
            message.append("&7 " + (moved.size() > 1 ? "were" : "was") + " moved to &7PvP");
