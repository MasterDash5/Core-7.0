...
public class CommandCreative extends CoreCommand {

    public CommandCreative() {
        super(true, PermissionType.NONE, "creative");
    }
    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        for (ProxiedPlayer target : targets) {
            if (target.equals(sender))
                MessageUtils.message(target, "&6&l» &7Sending you to &6Creative");
            else {
                ...
                message.append("&7 sent you to &6Creative");
